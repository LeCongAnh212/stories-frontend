<template>
    ...
    <p v-show="isError()" class="text-main-error">{{ props.error }}</p>
    <!-- <base-helper-text v-show="isError()" color="error" :value="errorField.value ?? props.error"
        :class="customClassHelperText" icon="warning"></base-helper-text> -->
</template>
